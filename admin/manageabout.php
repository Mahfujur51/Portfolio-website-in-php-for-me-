...
if(strlen($_SESSION['alogin'])==0)
{
	...
	if (isset($_POST['Update'])) {
		...
		$sql="UPDATE tbl_about SET name='$name',description='$description',email='$email',age='$age',phone='$phone',experience='$experience',location='$location',country='$country',freelancer='$freelancer' WHERE id='$id'";
		$query=mysqli_query($con,$sql);
		if ($query) {
			echo "<script>alert('Update Successfully!!')</script>";
			echo "<script>document.location='showabout.php'</script>";
		}else{
