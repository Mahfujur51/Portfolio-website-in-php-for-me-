...
if(strlen($_SESSION['alogin'])==0)
{
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO tbl_education (Subject,instituition,start,end,details) VALUES('$Subject','$instituition','$start','$end','$details')";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="instituition" placeholder="Enter Instituition Name">
                      </div>
                      <div class="form-group">
