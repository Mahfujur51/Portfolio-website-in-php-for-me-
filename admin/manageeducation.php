...
if(strlen($_SESSION['alogin'])==0)
{
	...
	if (isset($_POST['submit'])) {
		...
		$sql="UPDATE tbl_education SET Subject='$Subject',instituition='$instituition',start='$start',end='$end',details='$details' WHERE id='$id'";
		$query=mysqli_query($con,$sql);
		if ($query) {
echo "<script>alert('Update Successfully!!')</script>";
echo "<script>document.location='showeducation.php'</script>";
}else{
					...
					<div class="card-body">
						...
						<form class="forms-sample" method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="instituition" value="<?php echo $result['instituition'] ?>">
							</div>
							<div class="form-group">
